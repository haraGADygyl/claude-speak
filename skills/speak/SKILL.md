...
argument-hint: "[on|off|stop|status|speed 1.2|voice af_bella|voices|max 4000|mode queue|hold on|guard test|sound off|queue|pending|play|play all|clear|read FILE|test|audition|install|restart|log]"
